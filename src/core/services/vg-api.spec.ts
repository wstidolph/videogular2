...
describe('Videogular Player', () => {
    ...
    it('Should seek to a specified time by second', () => {
        ...
        expect(api.$$seek).toHaveBeenCalledWith(jasmine.objectContaining({id: 'main'}), 10, false);
        expect(api.$$seek).toHaveBeenCalledWith(jasmine.objectContaining({id: 'secondary'}), 10, false);
    });
    ...
    it('Should seek to a specified time by percentage', () => {
        ...
        expect(api.$$seek).toHaveBeenCalledWith(jasmine.objectContaining({id: 'main'}), 10, true);
        expect(api.$$seek).toHaveBeenCalledWith(jasmine.objectContaining({id: 'secondary'}), 10, true);
    });
